...
<script>
import {errorSwal, handleFileUpload, handleFileUploadOnly, handleRemoveFileUpload, hideBlockingOverlay, showBlockingOverlay, successSwal, warningSwal} from '@/services/method'

export default {
  methods: {
    handleFileUpload(event) {
      handleFileUploadOnly(event,this.images)
    },
